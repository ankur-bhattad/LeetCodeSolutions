package com.btd.ratelimiting.ayushbhatnagar;
...
public final class RateLimitManager {
    // Static singleton class which is thread safe from multiple instantiation race conditions 
    // in traditional singletons
